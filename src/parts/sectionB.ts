...
export default function getSectionA(phdVariables: IInputVariables) {
    ...
    const intro: Content = { text:'To be completed first by the doctoral student and then discussed (revised if necessary) with the thesis director (and co-director) during the Annual Report meeting.\nFuture objectives are meant to provide guidance in the project and should thus be as realistic as possible. Achieved and planned objectives should be discussed and agreed upon by the doctoral student and thesis director by approving the Annual Report. \n\n'}
