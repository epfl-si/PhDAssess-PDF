...
export default function getSectionA(phdVariables: IInputVariables) {
    ...
    const thesisCoDirectorComment1: Content = { text: [{text : 'Thesis co-director comment '}, {text: phdVariables.thesisDirectorComment1} ]}
    ...
    const thesisCoDirectorComment2: Content = { text: [{text : 'Thesis co-director comment '}, {text: phdVariables.thesisDirectorComment2} ]}
    ...
    const thesisCoDirectorComment3: Content = { text: [{text : 'Thesis co-director comment '}, {text: phdVariables.thesisDirectorComment3} ]}
    ...
    const thesisCoDirectorComment4: Content = { text: [{text : 'Thesis co-director comment '}, {text: phdVariables.thesisDirectorComment4} ]}
    ...
    const thesisCoDirectorComment5: Content = { text: [{text : 'Thesis co-director comment '}, {text: phdVariables.thesisDirectorComment5} ]}
    ...
    const thesisCoDirectorComment6: Content = { text: [{text : 'Thesis co-director comment '}, {text: phdVariables.thesisDirectorComment6} ]}
