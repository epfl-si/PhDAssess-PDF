...
export default function getSectionA(phdVariables: IInputVariables) {
    ...
    const section: Content = [{text: 'Section C: Progress assessment ', style: 'header'}]
    const intro: Content = { text: [{ text:'To be completed independently by the student and TD (and the co-TD if present), then discussed and approved by both during the AR meeting.'}, seperator,
                           { text:'Aims on the student side: \n'},
                           { text:'  -	to assess how the student views his/her own progress and skills\n', italics: true},
                           { text:'  -	to identify and communicate to the TD in what areas the student seeks more input or help', italics: true}, seperator,
                           { text:'Aims on the TD side:\n'},
                           { text:'  -	to ensure that your student knows how she/he is performing overall according to you\n', italics: true},
                           ...
                           { text:'Use the comments box to briefly assess the progress and further elaborate any specific issues. '},seperator]}
    const comment1: Content = [{text: 'Student’s engagement in the project :'  , bold: true}]
    const phdComment1: Content = { text: [{text : 'PhD comment : '}, {text: phdVariables.phdComment1} ]}
    ...
    const phdComment2: Content = { text: [{text : 'PhD comment : '}, {text: phdVariables.phdComment2} ]}
    ...
    const phdComment3: Content = { text: [{text : 'PhD comment : '}, {text: phdVariables.phdComment3} ]}
    ...
    const phdComment4: Content = { text: [{text : 'PhD comment : '}, {text: phdVariables.phdComment4} ]}
    ...
    const phdComment5: Content = { text: [{text : 'PhD comment : '}, {text: phdVariables.phdComment5} ]}
    ...
    const phdComment6: Content = { text: [{text : 'PhD comment : '}, {text: phdVariables.phdComment6} ]}
