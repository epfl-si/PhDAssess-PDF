...
export default function getSectionC(phdVariables: IInputVariables) {
    ...
    const intro: Content = { text: [{ text:'To be completed independently by the doctoral student and thesis director (and co-director if applicable), then discussed and approved by both during the Annual Report meeting. Progress evaluation is not confidential. During completion '}, seperator,
                           { text:'Aims on the doctoral student side: \n'},
                           { text:'  -	to assess how the doctoral student views their own progress and skills\n', italics: true},
                           { text:'  -	to identify and communicate to the thesis director in what areas the doctoral student seeks more input or help', italics: true}, seperator,
                           { text:'Aims on the thesis director (and co-director if applicable) side:\n'},
                           { text:'  -	to ensure that your doctoral students know how they are performing overall according to you\n', italics: true},
