...
export default function getSectionCCommentsAll(phdVariables: IInputVariables) {
    ...
    const phdComment3: Content = { text: [{text : 'Doctoral candidate comment:\n', bold: true}, {text: phdVariables.phdComment3} ]}
    ...
    const phdComment4: Content = { text: [{text : 'Doctoral candidate comment:\n', bold: true}, {text: phdVariables.phdComment4} ]}
    ...
    const phdComment5: Content = { text: [{text : 'Doctoral candidate comment:\n', bold: true}, {text: phdVariables.phdComment5} ]}
    ...
    const comment6: Content =  (phdVariables.phdComment6 && phdVariables.thesisDirectorComment6 && phdVariables.commonComment6) ?
